...
public:
  ...
  baby_base(const TString &filename); // Constructor to read tree

  int Add(const TString &filename);
  long GetEntries() const;
  virtual void GetEntry(const long entry);
  bool PassString(const std::string cut);
  ...
  std::vector<bool>  const & pfcands_charge() const;
  std::vector<bool>  & pfcands_charge();
  ...
  std::vector<float>  const & pfcands_eta() const;
  std::vector<float>  & pfcands_eta();
  std::vector<float>  const & pfcands_m() const;
  std::vector<float>  & pfcands_m();
  std::vector<float>  const & pfcands_phi() const;
  std::vector<float>  & pfcands_phi();
  std::vector<float>  const & pfcands_pt() const;
  std::vector<float>  & pfcands_pt();
  ...
  std::vector<int>  const & pfcands_frompv() const;
  std::vector<int>  & pfcands_frompv();
  std::vector<int>  const & pfcands_id() const;
  std::vector<int>  & pfcands_id();
...
private:
  ...
  std::vector<bool>  pfcands_charge_;
  std::vector<bool>  *p_pfcands_charge_;
  TBranch *b_pfcands_charge_;
  mutable bool c_pfcands_charge_;
  ...
  std::vector<float>  pfcands_eta_;
  std::vector<float>  *p_pfcands_eta_;
  TBranch *b_pfcands_eta_;
  mutable bool c_pfcands_eta_;
  std::vector<float>  pfcands_m_;
  std::vector<float>  *p_pfcands_m_;
  TBranch *b_pfcands_m_;
  mutable bool c_pfcands_m_;
  std::vector<float>  pfcands_phi_;
  std::vector<float>  *p_pfcands_phi_;
  TBranch *b_pfcands_phi_;
  mutable bool c_pfcands_phi_;
  std::vector<float>  pfcands_pt_;
  std::vector<float>  *p_pfcands_pt_;
  TBranch *b_pfcands_pt_;
  mutable bool c_pfcands_pt_;
  ...
  std::vector<int>  pfcands_frompv_;
  std::vector<int>  *p_pfcands_frompv_;
  TBranch *b_pfcands_frompv_;
  mutable bool c_pfcands_frompv_;
  std::vector<int>  pfcands_id_;
  std::vector<int>  *p_pfcands_id_;
  TBranch *b_pfcands_id_;
  mutable bool c_pfcands_id_;
